...
// GET: Users
        ...
        {
            var BookArchiveDataContext = _context.Users.Include(u => u.Role);
            return View(await BookArchiveDataContext.ToListAsync());
        }
...
// POST: Users/Delete/5
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return BadRequest("Entity set 'BookArchiveDataContext.Users' is null.");
            }
